...
advertisement can be done in one place only.</p>
		...
		<div class="about-row">
					<div class="col-md-6 about-row1">
						...
						<h6>Prayojan 2015</h6>
						<p>Prayojan 2015-Operations Conclave: MAKE IN INDIA-Opportunities and Challenges.<br>Prayojan 2015, the Operations Conclave with main theme as MAKE IN INDIA-Opportunities and Challenges is being organized by the Institute of Management, Nirma University on October 31, 2015.</p>
					</div>
					<div class="col-md-6  about-row1">
			...
			<div class="simply-grid">
				...
				<div class="our-ad">
					...
					<div class="col-md-5 our-in">
						<a><img class=" img-responsive" src="images/ab2.jpg" alt="">  </a>
					</div>
